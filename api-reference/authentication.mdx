...
The GlorIA API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your GlorIA account at [https://app.gloriagent.ai/](https://app.gloriagent.ai/)
...
```bash
curl -X GET "https://app.gloriagent.ai//api/user/campaigns" \
