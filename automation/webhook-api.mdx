...
If you want deeper customization beyond no-code blocks, GlorIA supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in GlorIA (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your GlorIA dashboard. Always secure your tokens and test endpoints in a dev environment.
