...
description: "Learn about GlorIA's built-in automation engine for creating workflows without coding"
---
...
GlorIA includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside GlorIA (e.g., "call ended," "inbound call context injection").
